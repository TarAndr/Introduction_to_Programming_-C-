...
int main()
{
    int razmer_nogi, kolichestvo_par, cnt = 0;
    
    set <int> Razmeri_obuvi;
    
    cin >> razmer_nogi >> kolichestvo_par;
    
    while(kolichestvo_par--) {
        int temp;
        cin >> temp;
        if(temp >= razmer_nogi) {
            Razmeri_obuvi.insert(temp);
        }
    }
    
    for(auto i : Razmeri_obuvi) {
        if(i >= razmer_nogi) {
            razmer_nogi = i + 3;
            cnt++;
        }
